...
# Инициализация расширения Flask-Migrate, связывая его с приложением и базой данных
...
class User(UserMixin, db.Model):
    ...
    is_admin = db.Column(db.Boolean, default=False)  # По умолчанию пользователь не администратор
...
def edit(post_id):
    ...
    # --- ИЗМЕНЕНО: Добавлена проверка на администратора ---
